 ...
 * The races have been implemented as an enumerate to make comparisons in player races quicker.
 * I have chosen to use underscore when naming the races to increase readability. */
public enum Race
{
    ...
    Embers_of_Muaat, Ghosts_of_Creuss, L1z1x_Mindnet, Arborec
}
